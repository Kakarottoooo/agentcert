...
4. Produce an AgentCert evidence bundle from an existing Tripwire, MCPBench, or
...
5. Confirm that **Runs** and **Evidence** show the same run, verdict, schema
...
Use the repository's **External pilot report** issue form. Never paste API keys,
